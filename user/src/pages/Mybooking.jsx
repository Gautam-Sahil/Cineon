  ...
  return !isLoading ? (
    <div className='relative px-6 md:px-16 lg:px-40 pt-30 md:pt-40 min-h-[80vh]'>
     ...
     {bookings.map((item, index) =>(
        <div key={index} className='flex flex-col md:flex-row justify-between items-center border border-primary/20 rounded-lg p-2 mt-4 max-w-3xl'>
         ...
         <div className='flex flex-col md:items-end md:text-right justify-between p-4'>
          <div className='flex items-center gap-4'>
            ...
            {!item.isPaid && <Link to={item.paymentLink } className='bg-primary px-4 py-1.5 rounded-md mb-3 text-sm font-medium cursor-pointer'>Pay Now</Link>}
          </div>
